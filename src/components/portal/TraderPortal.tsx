...
import { User, Order, Trade, MarketConfig, Notification } from '../../types';
      ...
      <main className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden pb-16">
        ...
        <header className="h-14 border-b bg-background flex items-center justify-between px-4 shrink-0 z-10">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 bg-slate-900 rounded flex items-center justify-center font-bold text-white dark:bg-white dark:text-slate-900">IM</div>
