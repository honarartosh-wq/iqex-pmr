    ...
    <Card className="flex flex-col h-[85vh] sm:h-[600px] border-border shadow-2xl bg-card overflow-hidden">
      ...
      <CardFooter className="p-3 sm:p-4 border-t bg-muted/30">
        <div className="flex w-full gap-2 sm:gap-3">
          ...
          />
          <Button onClick={handleSendMessage} className="bg-primary text-primary-foreground h-10 w-10 sm:h-12 sm:w-12 rounded-xl shadow-lg shadow-primary/20 hover:scale-105 transition-all flex-shrink-0">
