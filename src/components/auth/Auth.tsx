    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4 transition-colors duration-500 dark:bg-slate-950">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-3xl font-bold tracking-tight text-slate-900 dark:text-white">Iraq Metals</h1>
          <p className="text-slate-500 dark:text-slate-400">Institutional Precious Metals Trading</p>
        </div>
          ...
          <CardHeader>
            ...
            <CardDescription>
              {mode === 'login' 
                ...
                : 'Join Iraq\'s premier digital gold and silver bazaar.'}
            </CardDescription>
          </CardHeader>
